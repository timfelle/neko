...
contains
  ...
  subroutine opr_sx_curl(w1, w2, w3, u1, u2, u3, work1, work2, c_Xh)
    ...
    call opr_sx_dudxyz(work1, u3, c_Xh%drdy, c_Xh%dsdy, c_Xh%dtdy, c_Xh)
    if (gdim .eq. 3) then
       call opr_sx_dudxyz(work2, u2, c_Xh%drdz, c_Xh%dsdz, c_Xh%dtdz, c_Xh)
    ...
    if (gdim .eq. 3) then
       call opr_sx_dudxyz(work1, u1, c_Xh%drdz, c_Xh%dsdz, c_Xh%dtdz, c_Xh)
       call opr_sx_dudxyz(work2, u3, c_Xh%drdx, c_Xh%dsdx, c_Xh%dtdx, c_Xh)
    ...
    call opr_sx_dudxyz(work1, u2, c_Xh%drdx, c_Xh%dsdx, c_Xh%dtdx, c_Xh)
    call opr_sx_dudxyz(work2, u1, c_Xh%drdy, c_Xh%dsdy, c_Xh%dtdy, c_Xh)
